...
*   **Host**: PC Locale ("IronLab") - Cartella `Documenti-Analisi/NeuroForge`.
...
*   **Networking**:
    ...
    *   Domini: `kyros.neuroforge.club` (PWA), `mind.neuroforge.club` (n8n API).
...
*   **Database (PostgreSQL)**:
    ...
    *   Destinazione: Cartella locale sincronizzata su Cloud (es. `C:\Users\IronLab\OneDrive\Backups\Kyros`).
*   **Configurazioni (n8n)**:
...
3.  **Configurare n8n**:
    *   Accedere a `https://mind.neuroforge.club` (o `http://localhost:5678`).
...
| :--- | :--- | :--- | :--- | :--- |
| **n8n** | `https://mind.neuroforge.club` | `admin` | *(Vedi .env)* | Workflow Engine (Backend Logic) |
| **Kyros Client** | `https://kyros.neuroforge.club/` | N/A | N/A | Interfaccia Pubblica |
| **Kyros Admin** | `https://kyros.neuroforge.club/control-room` | N/A | N/A | Dashboard Gestore |
