...
1. Browser: `https://your-domain.example.com/`
...
1. Browser (altra tab): `https://your-domain.example.com/control-room/`
2. Login PIN: `1234`
...
1. Crea session senza heartbeat:
   ```bash
   curl -X POST https://your-domain.example.com/api/v1/client/sessions \
