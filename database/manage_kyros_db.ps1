...
$SuperUser = "turbo_g3pp3tto"  # Utente ADMIN (proprietario istanza Postgres)
...
$PossiblePaths = @(
    ...
    "$PSScriptRoot\..\..\Documenti-Analisi\NeuroForge\docker-compose.yml" # Caso: Sviluppo IronLab
)
